          ...
          if(value){
              switch(value[0]){
                case 'bac_informatique':
                  return (
                    <>
                      <input required id="ALGO" placeholder="algorithme" type="number" />
                      <input required id="STI" placeholder="sti" type="number" />
                      <input required id="M" placeholder="math" type="number" />
                      <input required id="SP" placeholder="science physique" type="number" />
                      <input required id="F" placeholder="français" type="number" />
                      <input required id="OP" placeholder="matière optionnelle" type="number" />
                      ...
                      <input name="text" id="ANG" required placeholder="anglais" type="number" />
                  ...
                  return(<>
                      ...
                      <input required id="SP" placeholder="science physique" type="number" />
                      <input required id="F" placeholder="français" type="number" />
                      <input required id="OP" placeholder="matiére optionel" type="number" />
                      <input required id="SPORT" placeholder="sport" type="number" />
                      <input required id="A" placeholder="arabic" type="number" />
                  ...
                  return(<>
                      ...
                      <input required="" id="M" placeholder="math" type="number" />
                      <input name="text" id="HG" required="" placeholder="histoire geographie" type="number"/>
                      <input required="" id="INF" placeholder="informatique" type="number" />
                      <input required="" id="F" placeholder="français" type="number" />
                      <input required="" id="OP" placeholder="matiére optionel" type="number" />
                  ...
                  return(<>
                      <input required="" id="M" placeholder="math" type="number" />
                      <input required="" id="ALGO" placeholder="algorithme" type="number" />
                      <input required="" id="SVT" placeholder="science exprimental" type="number" />
                      <input required="" id="SP" placeholder="science physique" type="number" />
                      <input required=""id="F"  placeholder="français" type="number" />
                      <input required="" id="OP" placeholder="matiére optionel" type="number" />
                      <input required="" id="SPORT" placeholder="sport" type="number" />
                  ...
                  return(<>
                      ...
                      <input required="" id="GEO" placeholder="geography" type="number" />
                      <input required="" id="PH" placeholder="filosophie" type="number" />
                      <input required="" id="SP" placeholder="science physique" type="number" />
                      <input required="" id="F" placeholder="français" type="number" />
                      <input required="" id="OP" placeholder="matiére optionel" type="number" />
                  ...
                  case 'bac_sport':
                  return(<>
                      <input required="" id="SPORTTH" placeholder="sport Tehorique" type="number" />
                      <input required="" id="SPORTPR" placeholder="sport Pratique" type="number" />
                      <input required="" id="M" placeholder="math" type="number" />
                      <input required="" id="SVT" placeholder="science biologiques" type="number" />
                      <input required="" id="SP" placeholder="science physique" type="number" />
                      <input required="" id="F" placeholder="français" type="number" />
                      <input required="" id="OP" placeholder="matiére optionel" type="number" />
                      <input required="" id="SPORT" placeholder="sport" type="number" />
      ...
      const Calculer = (event) => {
          ...
          switch (value[0]) {
            ...
            case 'bac_informatique':
              ...
              moyenne = 1.5 * M_info + 1.5 * ALGO + 0.5 * SP_info + 0.5 * TIC + 0.25 * (F_info + ANG_info);
              break;
        
            case 'bac_technique':
              const M_technique = parseFloat(document.getElementById("M").value) || 0;
              const TE = parseFloat(document.getElementById("TE").value) || 0;
              const SP_technique = parseFloat(document.getElementById("SP").value) || 0;
              const F_technique = parseFloat(document.getElementById("F").value) || 0;
              const ANG_technique = parseFloat(document.getElementById("ANG").value) || 0;
              moyenne = 1.5 * M_technique + 1.5 * TE + 1 * SP_technique + 0.5 * (F_technique + ANG_technique);
              break;
            case 'bac_lettre':
              ...
              const ANG_lettre = parseFloat(document.getElementById("ANG").value) || 0;
            ...
            case 'bac_sport':
              ...
              const SPORTTH = parseFloat(document.getElementById("SPORTTH").value) || 0;
              const SPORTPR = parseFloat(document.getElementById("SPORTPR").value) || 0;
              ...
              moyenne = SVT_sport + 0.5 * (SPORTTH + SPORTPR) + 0.5 * SPORT + 0.25 * (F_sport + ANG_sport) + PH_sport;
              break;
            case 'bac_economie_gestion':
              ...
              moyenne = (1.5 * EC + 1.5 * GE + 0.5 * M_eco + 0.5 * HG_eco + 0.5 * (F_eco + ANG_eco));
              break;
            default:
              break;
          }
        ...
        numberInputs.forEach(el=>{el.addEventListener("input",()=>{
        if (el.value>20 || el.value<0){
          el.style.cssText="color:red; border-color:#C70039;outline:#C70039;box-shadow: 0px 0px 3px 0px orange;";
        }else{el.style.cssText="color:initial; border-color:#1AACAC;outline:initial";
        }
        if (Array.from(numberInputs).some(inp => inp.style.color === "red")) {
              ...
              return(
                  <section className="section_form" action="#">
                      <form id="consultation-form" className="feed-form" action="#">
                          {choose_form()}
                          <button className="button_submit" onClick={Calculer}>Calculez moyenne et score</button>
                          <ToastContainer position="bottom-right"/>

                      </form>
                        <Link to="/wajahni/calcScoreForm/:value/propositions"><button className="suivant" style={st}><span>Poursuivre</span></button></Link>
                  </section>)
          }
